...
__attribute__((always_inline)) inline void JavaUtilLinkedHashMap_init() {}
...
__attribute__((always_inline)) inline void JavaUtilLinkedHashMap_LinkedEntry_init() {}
...
__attribute__((always_inline)) inline void JavaUtilLinkedHashMap_LinkedHashIterator_init() {}
...
__attribute__((always_inline)) inline void JavaUtilLinkedHashMap_KeyIterator_init() {}
...
__attribute__((always_inline)) inline void JavaUtilLinkedHashMap_ValueIterator_init() {}
...
__attribute__((always_inline)) inline void JavaUtilLinkedHashMap_EntryIterator_init() {}
